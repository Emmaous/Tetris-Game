...
namespace Tetris_Game
{
    ...
    {
        private readonly Position[][] occupTiles = new Position[][] // array representing all possible position of the T-block
        {
        ...
        public override int BlockId => 6; //set T-block ID to 6
