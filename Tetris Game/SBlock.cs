...
namespace Tetris_Game
{
    ...
    {
        private readonly Position[][] occupTiles = new Position[][] // array representing all possible position of the S-block
        {
        ...
        public override int BlockId => 5; //set S-block ID to 5
